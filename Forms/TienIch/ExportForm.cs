...
namespace NamDinh_QLBN.Forms.Tien_ich
{
	...
	public class ExportForm : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.pnlFill.Size = new System.Drawing.Size(458, 151);
			this.pnlFill.TabIndex = 2;
			// 
			// pnlOptions
			// 
			this.pnlOptions.Controls.Add(this.pg);
			...
			this.pg.Size = new System.Drawing.Size(440, 88);
			this.pg.TabIndex = 0;
			...
			try
			{
				...
				switch(cboExportFormat.SelectedIndex)
				{
					...
					case 4:
						...
						break;
					case 5:
                        ((XlsExport)export).UseCellMerging = true;

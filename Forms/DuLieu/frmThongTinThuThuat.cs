...
{
    public partial class frmThongTinThuThuat : Form
    {
        public frmThongTinThuThuat()
        {
            InitializeComponent();
        }
        ...
        private void cmdChiDinh_Click(object sender, EventArgs e)
        {
            ...
            NamDinh_QLBN.Forms.DuLieu.frmNhapChiDinhChiPhi fr = new frmNhapChiDinhChiPhi(fgDichVu, fgDanhSach.GetDataDisplay(fgDanhSach.Row,"DoiTuong"), cmbKhoa.Columns[1].CellText(cmbKhoa.SelectedIndex), DateTime.Parse(fgDanhSach.GetDataDisplay(fgDanhSach.Row, "NgayVaoVien")));
            fr.ShowDialog();
        }

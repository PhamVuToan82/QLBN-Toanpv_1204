...
{
	/// <summary>
	/// Summary description for frmCapNhatKipMo_PhongMo.
	/// </summary>
	public class frmCapNhatKipMo_PhongMo : System.Windows.Forms.Form
	{
		/// <summary>
        ...
        public frmCapNhatKipMo_PhongMo(C1.Win.C1FlexGrid.C1FlexGrid  _fg,string _B5ChiDinh, DateTime _timeBatDau, DateTime _timeKetThuc)
		{
			//
            ...
            timeBatDau = _timeBatDau;
            timeKetThuc = _timeKetThuc;
		...
		private void InitializeComponent()
		{
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmCapNhatKipMo_PhongMo));
            ...
            this.cmbBacSy.SelectedValueChanged += new System.EventHandler(this.cmbBacSy_SelectedValueChanged);
            this.cmbBacSy.BeforeOpen += new System.ComponentModel.CancelEventHandler(this.cmbBacSy_BeforeOpen);
            ...
            this.fgKipMo.Location = new System.Drawing.Point(3, 121);
            ...
            this.fgKipMo.Size = new System.Drawing.Size(463, 113);
            ...
            this.cmdEdit.Location = new System.Drawing.Point(3, 240);
            ...
            this.cmdThoat.Location = new System.Drawing.Point(397, 240);
            ...
            this.label3.Text = "DANH SACH BENH NHAN DANG PHAU THUAT";
            this.label3.TextAlign = System.Drawing.ContentAlignment.TopRight;
            // 
            // frmCapNhatKipMo_PhongMo
            // 
            ...
            this.Name = "frmCapNhatKipMo_PhongMo";
        ...
        private void Load_BacSy(string MaKhoa)
        {
            ...
            while (dr.Read())
            {
                this.cmbBacSy.AddItem(string.Format("{0};{1};{2}", dr["MaBS"], dr["TenBS"], dr["MA_BHXH"]));
            }
            dr.Close();
            SQLCmd.Dispose();
		...
		private void cmdEdit_Click(object sender, System.EventArgs e)
		{
			...
			for (int i=1;i<fg.Rows.Count;i++)
			{
                ...
                //string s = GlobalModuls.Global.GetCode(cmbKhoa);
                
                //if(GlobalModuls.Global.GetCode(cmbKhoa) = "")
            }
            for(int i =1; i<=fgKipMo.Rows.Count;i++)
            {
                if (fgKipMo.Rows.Count > 1 && cmbKhoa.Columns[0].CellText(cmbKhoa.SelectedIndex) != "NV1103")
                {
                    MessageBox.Show("Bác sỹ / kỹ thuật viên " + cmbBacSy.Text + " đang thực hiệp mổ cho Bệnh nhân " + fgKipMo.GetDataDisplay(i, "TenBenhNhan") + "\nĐề nghị chuyển Bác sỹ/ Kỹ thuật viên khác", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    return;
                }
            }

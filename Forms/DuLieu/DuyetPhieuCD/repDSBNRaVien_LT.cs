...
namespace NamDinh_QLBN.Forms.DuLieu.DuyetPhieuCD
{
    ...
    /// </summary>
    public partial class  repDSBNRaVien_LT : DataDynamics.ActiveReports.ActiveReport3
    {
        private System.DateTime _TNgay, _DNgay;
        private String _MaKhoa;
        private String _TrangThai;
        public repDSBNRaVien_LT(System.DateTime TNgay, System.DateTime DNgay, String MaKhoa, String TenKhoa,string TrangThai)
        {
            //
        ...
        private void repDSBNNhapVien_ReportStart(object sender, EventArgs e)
        {
            ...
            this.PageSettings.Margins.Left = (float)0.1;
        ...
        private void repDSBNNhapVien_DataInitialize(object sender, EventArgs e)
        {
            ...
            _ds.SQL = String.Format("SELECT B.SOHSBA,A.HOTEN,YEAR(KHOA_CD.NGAYCHUYEN) - A.NAMSINH AS TUOI,CASE WHEN A.GIOITINH = 0 THEN N'Nữ' ELSE N'Nam' END AS GIOITINH,"
                ...
                + " KHOA_CD.NGAYCHUYEN AS NGAYVAOVIEN,B.NGAYRAVIEN,B.SOLUUTRU,KHOADANGDT.MAKHOA,KHOADANGDT.TENKHOA AS KHOADANGDT FROM"
        ...
        private void detail_BeforePrint(object sender, EventArgs e)
        {
            ...
            = textBox8.Height  = textBox10.Height = textBox11.Height= detail.Height;
        }

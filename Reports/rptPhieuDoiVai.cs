...
namespace NamDinh_QLBN.Reports
{
    ...
    /// </summary>
    public partial class rptPhieuDoiVai : DataDynamics.ActiveReports.ActiveReport3
    {
        private int STT = 1;
        int page = 0;
        ...
        public rptPhieuDoiVai(DateTime Ngay,DateTime NgayHT, string Khoa)
        {
            //
        ...
        private void rptPhieuDoiVai_PageStart(object sender, EventArgs e)
        {
            page += 1;
        ...
        private void rptPhieuDoiVai_DataInitialize(object sender, EventArgs e)
        {
            DataDynamics.ActiveReports.DataSources.SqlDBDataSource _ds = new DataDynamics.ActiveReports.DataSources.SqlDBDataSource();
            _ds.ConnectionString = GlobalModuls.Global.glbConnectionString;
            _ds.SQL = string.Format("set dateformat dmy SELECT  b.TenDoVai,c.Dvt,SUM(b.soluong_doi) as SoLuong,a.TenKhoa FROM NAMDINH_QLBN.dbo.tblbenhnhan_muonvai a inner join NAMDINH_QLBN.dbo.tblPhieudoi_vai b on a.MaKhambenh = b.MaKhamBenh "

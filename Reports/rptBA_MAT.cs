...
namespace NamDinh_QLBN.Reports
{
    ...
    /// Summary description for rptChiPhiPT
    /// </summary>
    public partial class rptBA_MAT : DataDynamics.ActiveReports.ActiveReport3
    {
        string _MaVaoVien, _TenKhoa, _NgayChuyen, _NgayDT,_Hsba,_LuuTru;
        int _LoaiBenhAn;
        public rptBA_MAT(string MaVaoVien, string TenKhoa, string NgayChuyen, string NgayDT, string hsba, string Luutru, int LoaiBenhAn)
        {
            //
        ...
        {
            Subrpt_BenhAn_TongKet_Mat rpttongket = new Subrpt_BenhAn_TongKet_Mat(_MaVaoVien);
            subReport5.Report = rpttongket;
        }

        private void groupFooter2_Format(object sender, EventArgs e)
        {
            Subrpt_BenhAn_BA_MAT rtpBenhAn = new Subrpt_BenhAn_BA_MAT(_MaVaoVien,_LoaiBenhAn);

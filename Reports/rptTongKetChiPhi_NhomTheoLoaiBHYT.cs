...
namespace NamDinh_QLBN.Reports
{
    ...
    /// </summary>
    public partial class rptTongKetChiPhi_NhomTheoLoaiBHYT : DataDynamics.ActiveReports.ActiveReport3
    {
        ...
        public rptTongKetChiPhi_NhomTheoLoaiBHYT(string MaBenhNhan, string TenBN, string Tuoi, string GioiTinh, string DoiTuong, object NgayVaoVien, string DiaChi, string HanTheTu, string HanTheDen, string SoThe, string NoiCap, string Buong, string Giuong, object NgayRaVien, string ChanDoan, string NoiGioiThieu, String SoHSBA,string MaKhoa,string LoaiBenhAn,string CapCuu)
        {
            //
            ...
            if (CapCuu == "1")
            {
                txtCapCuu.Text = "X"; txtDungTuyen.Text = ""; txtTraiTuyen.Text = "";
            }
            else txtCapCuu.Text = "";
        }
        ...
        {
            string s1 = textBox60.Text.Substring(0, textBox60.Text.Length);
            string s2 = textBox61.Text.Substring(0, textBox61.Text.Length);
            string s3 = textBox62.Text.Substring(0, textBox62.Text.Length);
            txtTongTien.Text = string.Format("{0:#,###.00}", long.Parse(s1.Replace(".", "")) + long.Parse(s2.Replace(".", "")) + long.Parse(s3.Replace(".", "")));
            //if(txt4.Text == ",00")

            //textBox61.Text = "0";
            //else
            //    textBox61.Text = txt4.Text;
            //if (txt3.Text == ",00")
            //    textBox62.Text = "0";
            //else
            //    textBox62.Text = txt3.Text;
            //textBox60.Text = txt2.Text;
            //if (txt2.Text == ",00")
            //    textBox60.Text = "0";
            //else textBox60.Text = txt2.Text; 
            txtTongTien.Text = txt1.Text;
            if (txtTongTien.Text != "0") txt1.Text = GlobalModuls.Global.WriteNum(long.Parse(s1.Replace(".", "")) + long.Parse(s2.Replace(".", "")) + long.Parse(s3.Replace(".", ""))) + " đồng";
            else txt1.Text = "";
            if (textBox60.Text != "0") txt2.Text = GlobalModuls.Global.WriteNum(long.Parse(s1.Replace(".", ""))) + " đồng";
            else txt2.Text = "";
            if (textBox61.Text != "0") txt4.Text = GlobalModuls.Global.WriteNum(long.Parse(s2.Replace(".", ""))) + " đồng";
            else txt4.Text = "";
            if (textBox62.Text != "0") txt3.Text = GlobalModuls.Global.WriteNum(long.Parse(s3.Replace(".", ""))) + " đồng";
            else txt3.Text = "";
        }
        ...
        private void rptTongKetChiPhi_NhomTheoLoaiBHYT_FetchData(object sender, FetchEventArgs eArgs)
        {
            ...
            else
            {
                ...
                if ( txtCapCuu.Text == "X" &&(Fields["tuyen"].Value.ToString() == "0"|| Fields["tuyen"].Value.ToString() == "1"))
                {
                    txtDungTuyen.Text = "";
                    txtTraiTuyen.Text = "";
                    txtCapCuu.Text = "X";
                ...
                if (Fields["tuyen"].Value.ToString() == "0"&& (txtCapCuu.Text == "" || Fields["tuyen"].Value.ToString() == "1"))
                {
                    txtDungTuyen.Text = "X";
                    txtTraiTuyen.Text = "";
                    txtCapCuu.Text = "";
                }
                if (Fields["tuyen"].Value.ToString() == "1" &&(txtCapCuu.Text == "" || Fields["tuyen"].Value.ToString() == "1" ))//|| Fields["tuyen"].Value.ToString().ToUpper() == "false")
                {
                    txtDungTuyen.Text = "";
                    txtTraiTuyen.Text = "X";
                    txtCapCuu.Text = "";
                ...
                //if (Fields["CapCuu"].Value.ToString() == "2")// || Fields["CapCuu"].Value.ToString().ToUpper() == "false")
                //{
                //    txtCapCuu.Text = "X";

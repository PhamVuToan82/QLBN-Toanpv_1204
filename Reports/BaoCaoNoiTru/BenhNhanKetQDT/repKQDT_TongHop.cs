...
namespace NamDinh_QLBN.Reports.BaoCaoNoiTru.BenhNhanKetQDT
{
    ...
    /// </summary>
    public partial class repKQDT_TongHop : DataDynamics.ActiveReports.ActiveReport3
    {
        ...
        public repKQDT_TongHop(System.DateTime TNgay, System.DateTime DNgay, String MaKhoa, String TenKhoa, String KetQDT,
        ...
        private void repCLS_TongHopByBS_DataInitialize(object sender, EventArgs e)
        {
            ...
            _ds.SQL = String.Format("SELECT CASE WHEN YEAR(C.NGAYCHUYEN) - A.NAMSINH <= 6 THEN N'TE6' ELSE N'NL' END AS TUOI,"
                + " E.DOITUONG,E.MADOITUONGBHXH,B.TRANGTHAI,B.NOIRAVIEN,B.DARAVIEN,"
            ...
            _ds.SQL += String.Format(" ORDER BY D.TENKQDT");
            this.DataSource = _ds;

...
namespace NamDinh_QLBN.Reports.BaoCaoNoiTru
{
    ...
    /// </summary>
    public partial class repDSBNNhanTuKhoaKhacChuyenDen : DataDynamics.ActiveReports.ActiveReport3
    {
        private System.DateTime _TNgay, _DNgay;
        private String _MaKhoa;
        public repDSBNNhanTuKhoaKhacChuyenDen(System.DateTime TNgay, System.DateTime DNgay, String MaKhoa, String TenKhoa)
        {
            //
        ...
        private void repDSBNNhapVien_DataInitialize(object sender, EventArgs e)
        {
            ...
            _ds.SQL = String.Format("SELECT B.SOHSBA,A.HOTEN,YEAR(C.NGAYCHUYEN) - A.NAMSINH AS TUOI,CASE WHEN A.GIOITINH = 0 THEN N'Nữ' ELSE N'Nam' END AS GIOITINH,"
                + " DMDOITUONGBN.TENDT,DMKHOAPHONG.TENKHOA,C.NGAYCHUYEN,B.DIACHI FROM"
                ...
                + " INNER JOIN DMKHOAPHONG ON DMKHOAPHONG.MAKHOA = C.MAKHOACD"
                + " WHERE C.MAKHOA = '{0}'  AND DATEDIFF(dd,C.NGAYCHUYEN,'{1:MM/dd/yyyy}') <= 0 AND DATEDIFF(dd,C.NGAYCHUYEN,'{2:MM/dd/yyyy}') >= 0 AND DMKHOAPHONG.IS_KHOADIEUTRI = 1"
        ...
        private void detail_BeforePrint(object sender, EventArgs e)
        {
            ...
            = textBox8.Height = textBox9.Height = detail.Height;
        }

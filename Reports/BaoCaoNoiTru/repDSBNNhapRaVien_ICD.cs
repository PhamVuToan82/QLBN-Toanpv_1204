...
namespace NamDinh_QLBN.Reports.BaoCaoNoiTru
{
    ...
    /// </summary>
    public partial class repDSBNNhapRaVien_ICD : DataDynamics.ActiveReports.ActiveReport3
    {
        private System.DateTime _TNgay, _DNgay;
        private String _MaKhoa;
        public repDSBNNhapRaVien_ICD(System.DateTime TNgay, System.DateTime DNgay, String MaKhoa, String TenKhoa)
        {
            //
        ...
        private void repDSBNNhapVien_DataInitialize(object sender, EventArgs e)
        {
            ...
            _ds.SQL = String.Format("set dateformat dmy "
                                + " select a.Mavaovien, benhnhan.Hoten, benhnhan.Namsinh, b.NgayChuyenDau, a.ngayravien, a.chandoanravien, c.CICD10, c.VVIET, a.Chuyenvien_chuyendenbv"
                ...
                + " ORDER BY c.CICD10,NGAYRAVIEN", _MaKhoa,_TNgay,_DNgay);
            this.DataSource = _ds;
        }

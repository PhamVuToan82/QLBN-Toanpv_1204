...
namespace NamDinh_QLBN.Reports.BaoCaoNoiTru.PhauThuat
{
    ...
    /// </summary>
    public partial class repTHPhauThuat_ByBS_KhoaThucHien : DataDynamics.ActiveReports.ActiveReport3
    {
        ...
        public repTHPhauThuat_ByBS_KhoaThucHien(System.DateTime TNgay, System.DateTime DNgay, String MaKhoa, String TenKhoa, bool isTatCa,
        ...
        private void repTHPhauThuat_ByBS_DataInitialize(object sender, EventArgs e)
        {
            ...
            _ds.SQL = String.Format("SELECT CASE WHEN DMBACSY.TENBS IS NULL THEN N'Không có BS chỉ định' ELSE DMBACSY.TENBS END AS TENBS,DMBACSY.MABS,C.DOITUONG,A.NHOM,"
                ...
                + " inner join NAMDINH_SYSDB.dbo.DMDICHVU_KHOA  on DMDICHVU_KHOA.MaKhoa = A.MaKhoa and DMDICHVU_KHOA.MaDichVu = B.MaDichVu"

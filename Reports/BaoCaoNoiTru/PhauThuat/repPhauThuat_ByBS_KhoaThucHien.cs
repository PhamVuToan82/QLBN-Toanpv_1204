...
namespace NamDinh_QLBN.Reports.BaoCaoNoiTru.PhauThuat
{
    ...
    /// </summary>
    public partial class repPhauThuat_ByBS_KhoaThucHien : DataDynamics.ActiveReports.ActiveReport3
    {
        ...
        public repPhauThuat_ByBS_KhoaThucHien(System.DateTime TNgay, System.DateTime DNgay, String MaKhoa, String TenKhoa, bool isTatCa,
        ...
        private void repCLS_ByBS_DataInitialize(object sender, EventArgs e)
        {
            ...
            _ds.SQL = String.Format("SELECT B.SOHSBA,A.HOTEN,YEAR(C.NGAYCHIDINH) - A.NAMSINH AS TUOI,CASE WHEN A.GIOITINH = 0 THEN N'Nữ' ELSE N'Nam' END AS GIOITINH,"
                ...
                + " inner join NAMDINH_SYSDB.dbo.DMDICHVU_KHOA  on DMDICHVU_KHOA.MaKhoa = C.MaKhoa and DMDICHVU_KHOA.MaDichVu = D.MaDichVu"

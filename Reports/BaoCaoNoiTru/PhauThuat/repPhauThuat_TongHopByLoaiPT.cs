...
namespace NamDinh_QLBN.Reports.BaoCaoNoiTru.PhauThuat   
{
    ...
    /// </summary>
    public partial class repPhauThuat_TongHopByLoaiPT : DataDynamics.ActiveReports.ActiveReport3
    {
        ...
        public repPhauThuat_TongHopByLoaiPT(System.DateTime TNgay, System.DateTime DNgay, String MaKhoa, String TenKhoa, bool isTatCa,
        ...
        private void repCLS_TongHopByBS_DataInitialize(object sender, EventArgs e)
        {
            ...
            if (_MaLoaiPT == "0")
                ...
                _ds.SQL += string.Format(" AND B.LOAIDICHVU = '{0}'", _MaLoaiPT);

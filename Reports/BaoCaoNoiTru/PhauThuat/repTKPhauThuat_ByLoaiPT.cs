...
namespace NamDinh_QLBN.Reports.BaoCaoNoiTru.PhauThuat
{
    ...
    /// </summary>
    public partial class  repTKPhauThuat_ByLoaiPT : DataDynamics.ActiveReports.ActiveReport3
    {
        ...
        public repTKPhauThuat_ByLoaiPT(System.DateTime TNgay, System.DateTime DNgay, String MaKhoa, String TenKhoa, bool isTatCa,
        ...
        private void repCLS_ByBS_DataInitialize(object sender, EventArgs e)
        {
            ...
            {
                _ds.SQL += string.Format(" AND DMPHAUTHUAT.LOAIPHAUTHUAT LIKE '{0}'", _MaLoaiPT);
            }
            if (_MaBS != "0")
            {

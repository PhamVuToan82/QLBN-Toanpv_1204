...
namespace NamDinh_QLBN.Reports.BaoCaoNoiTru.ThuThuat
{
    ...
    /// </summary>
    public partial class repThuThuat_ByBS : DataDynamics.ActiveReports.ActiveReport3
    {
        ...
        public repThuThuat_ByBS(System.DateTime TNgay, System.DateTime DNgay, String MaKhoa, String TenKhoa, bool isTatCa,
        ...
        private void repCLS_ByBS_DataInitialize(object sender, EventArgs e)
        {
            ...
            {
                _ds.SQL += string.Format(" AND DMLOAIPHAUTHUAT.MALOAIPT LIKE '{0}'", _MaLoaiTT);
            }
            if (_MaBS != "0")
            {

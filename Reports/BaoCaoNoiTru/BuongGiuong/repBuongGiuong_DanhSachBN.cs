...
namespace NamDinh_QLBN.Reports.BaoCaoNoiTru.BuongGiuong
{
    ...
    /// </summary>
    public partial class repBuongGiuong_DanhSachBN : DataDynamics.ActiveReports.ActiveReport3
    {
        ...
        public repBuongGiuong_DanhSachBN(System.DateTime TNgay, System.DateTime DNgay, String MaKhoa, String TenKhoa, int Buong,int Giuong,
        ...
        private void repDanhSachBNChuyenVien_DataInitialize(object sender, EventArgs e)
        {
            ...
            _ds.SQL = String.Format("SELECT B.SOHSBA,A.HOTEN, YEAR(C.NGAYCHUYEN) - A.NAMSINH AS TUOI,CASE WHEN A.GIOITINH = 0 THEN N'Nữ' ELSE N'Nam' END AS GIOITINH,"
                ...
                + " CASE WHEN B.DARAVIEN = 1 THEN N'Đã ra viện' ELSE N'Đang điều trị' END AS TRANGTHAI,C.NGAYCHUYEN,DMBUONGBENH.TENBUONG,DMGIUONGBENH.TENGIUONG FROM"

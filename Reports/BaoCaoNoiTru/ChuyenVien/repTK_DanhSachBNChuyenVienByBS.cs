...
namespace NamDinh_QLBN.Reports.BaoCaoNoiTru.ChuyenVien
{
    ...
    /// </summary>
    public partial class  repTK_DanhSachBNChuyenVienByBS : DataDynamics.ActiveReports.ActiveReport3
    {
        private System.DateTime _TNgay, _DNgay;
        private String _MaKhoa,_MaBV,_MaBS;

        public repTK_DanhSachBNChuyenVienByBS(System.DateTime TNgay, System.DateTime DNgay, String MaKhoa, String TenKhoa, string MaBV,string MaBS)
        {
            //

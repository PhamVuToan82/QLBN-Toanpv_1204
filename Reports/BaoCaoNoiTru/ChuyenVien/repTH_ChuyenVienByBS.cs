...
namespace NamDinh_QLBN.Reports.BaoCaoNoiTru.ChuyenVien
{
    ...
    /// </summary>
    public partial class repTH_ChuyenVienByBS : DataDynamics.ActiveReports.ActiveReport3
    {
        private System.DateTime _TNgay, _DNgay;
        private String _MaKhoa,_MaBS,_MaBV;

        public repTH_ChuyenVienByBS(System.DateTime TNgay, System.DateTime DNgay, String MaKhoa, String TenKhoa, string MaBS,string MaBV)
        {
            //

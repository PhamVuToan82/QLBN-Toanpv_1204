...
namespace NamDinh_QLBN.Reports.BaoCaoNoiTru.ChuyenVien
{
    ...
    /// </summary>
    public partial class repDanhSachBNChuyenVien : DataDynamics.ActiveReports.ActiveReport3
    {
        private System.DateTime _TNgay, _DNgay;
        private String _MaKhoa;

        public repDanhSachBNChuyenVien(System.DateTime TNgay, System.DateTime DNgay, String MaKhoa, String TenKhoa)
        {
            //
        ...
        private void repDanhSachBNChuyenVien_DataInitialize(object sender, EventArgs e)
        {
            ...
            _ds.SQL = String.Format("SELECT B.SOHSBA,A.HOTEN,YEAR(B.NGAYRAVIEN) - A.NAMSINH AS TUOI,CASE WHEN A.GIOITINH = 0 THEN N'Nữ' ELSE N'Nam' END AS GIOITINH,"
                ...
                + " BENHNHAN_KHOA.NGAYCHUYEN,B.NGAYRAVIEN,B.CHUYENVIEN_CHUYENDENBV FROM"
                ...
                + " AND B.DARAVIEN = 1 AND B.NOIRAVIEN = 4 ORDER BY B.NGAYRAVIEN", _MaKhoa, _TNgay, _DNgay);
            this.DataSource = _ds;
        }

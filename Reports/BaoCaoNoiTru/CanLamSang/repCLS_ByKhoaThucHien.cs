...
namespace NamDinh_QLBN.Reports.BaoCaoNoiTru.CanLamSang
{
    ...
    /// </summary>
    public partial class  repCLS_ByKhoaThucHien : DataDynamics.ActiveReports.ActiveReport3
    {
        ...
        public repCLS_ByKhoaThucHien(System.DateTime TNgay, System.DateTime DNgay, String MaKhoa, String TenKhoa, bool isTatCa,
        ...
        private void repCLS_ByBS_DataInitialize(object sender, EventArgs e)
        {
            ...
            _ds.SQL = String.Format("SELECT B.SOHSBA,A.HOTEN,YEAR(C.NGAYCHIDINH) - A.NAMSINH AS TUOI,CASE WHEN A.GIOITINH = 0 THEN N'Nữ' ELSE N'Nam' END AS GIOITINH,"
                + " F.TENDT,C.NGAYCHIDINH,DMDICHVU.TENDICHVU,D.SOLUONG,DMDICHVU.DVT,DMBACSY.MABS,DMBACSY.TENBS,D.LOAIDICHVU,DMLOAIDICHVU.TENLOAIDICHVU FROM"
                ...
                + " inner join DMDICHVU_KHOA DVKHOA ON DVKHOA.MaDichvu = D.MaDichVu AND DVKHOA.MaKhoa = C.MaKhoa"
            ...
            _ds.SQL += " ORDER BY DMLOAIDICHVU.TENLOAIDICHVU,DMBACSY.TENBS,DMBACSY.MaBS,A.HOTEN,DMDICHVU.TENDICHVU";
            this.DataSource = _ds;
        }

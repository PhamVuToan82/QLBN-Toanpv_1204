...
{
    /// <summary>
    /// Summary description for repCLS_TongHopByKhoaThucHien.
    /// </summary>
    public partial class repCLS_TongHopByKhoaThucHien : DataDynamics.ActiveReports.ActiveReport3
    {
        ...
        public repCLS_TongHopByKhoaThucHien(System.DateTime TNgay, System.DateTime DNgay, String MaKhoa, String TenKhoa, bool isTatCa,
        ...
        private void repCLS_TongHopByKhoaThucHien_ReportStart(object sender, EventArgs e)
        {
        ...
        private void repCLS_TongHopByKhoaThucHien_DataInitialize(object sender, EventArgs e)
        {
            ...
            _ds.SQL = String.Format("SELECT B.MAVAOVIEN,DMBACSY.MABS,CASE WHEN DMBACSY.TENBS IS NULL THEN N'Không có tên' ELSE DMBACSY.TENBS END TENBS,YEAR(C.NGAYCHIDINH) - A.NAMSINH AS TUOI,"
                ...
                + " INNER JOIN DMDICHVU_KHOA DVKHOA ON DVKHOA.MAKHOA = C.MAKHOA AND DVKHOA.MADICHVU = D.MADICHVU "
        ...
        private void repCLS_TongHopByKhoaThucHien_FetchData(object sender, FetchEventArgs eArgs)
        {
            if (eArgs.EOF)
            {
            }

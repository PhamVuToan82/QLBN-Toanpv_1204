...
namespace NamDinh_QLBN.Reports.BaoCaoNoiTru.Mau
{
    ...
    /// </summary>
    public partial class repMau_TongHopByBS : DataDynamics.ActiveReports.ActiveReport3
    {
        ...
        public repMau_TongHopByBS(System.DateTime TNgay, System.DateTime DNgay, String MaKhoa, String TenKhoa, bool isTatCa,
        ...
        private void repCLS_TongHopByBS_DataInitialize(object sender, EventArgs e)
        {
            ...
            if (_MaCLS == "0")
                _ds.SQL += string.Format(" AND B.LOAIDICHVU = '{0}'", _Like);
            else

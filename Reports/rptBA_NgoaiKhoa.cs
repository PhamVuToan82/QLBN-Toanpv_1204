...
namespace NamDinh_QLBN.Reports
{
    ...
    /// </summary>
    public partial class rptBA_NgoaiKhoa : DataDynamics.ActiveReports.ActiveReport3
    {
        string _MaVaoVien, _TenKhoa, _NgayChuyen, _NgayDT,_Hsba,_LuuTru;
        int _LoaiBenhAn;
        public rptBA_NgoaiKhoa(string MaVaoVien, string TenKhoa, string NgayChuyen, string NgayDT, string hsba, string Luutru, int LoaiBenhAn)
        {
            //

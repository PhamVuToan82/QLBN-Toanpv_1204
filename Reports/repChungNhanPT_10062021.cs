...
namespace NamDinh_QLBN.Reports
{
    ...
    /// </summary>
    public partial class repChungNhanPT_10062021 : DataDynamics.ActiveReports.ActiveReport3
    {
        private String _MaVaoVien;
        private String _NgayRaVien;
        public repChungNhanPT_10062021(String MaVaoVien,string NgayRaVien)
        {
            //
            ...
            label11.Text = "Ngày " + subString[0] + " Tháng " + subString[1] + " Năm " + subString[2].Substring(0,4);           
        ...
        private void repChungNhanPT_FetchData(object sender, FetchEventArgs eArgs)
        {
            if(Fields["MaKhoa"].Value != null)
            {
                ...
                {
                    label21.Text = "GIÁM ĐỐC TRUNG TÂM";
                }
            }
            string s = Fields["CachThuc"].Value.ToString();
        }
        ...
        private void repChungNhanPT_10062021_DataInitialize(object sender, EventArgs e)
        {
           ...
           + " select @NhomMau=KetQua from BENHNHAN_PHIEUDIEUTRI pdt inner join NAMDINH_CLS.dbo.KETQUAXETNGHIEM kq "
               ...
               + " select SoHSBA,HoTen,DiaChi,NamSinh,case GioiTinh when 1 then N'Nam' else N'Nữ' end as GioiTinh,NgayVaoVien,NgayRaVien,bs.TenBS as BSChinh,@BSphu as BSPhu,"

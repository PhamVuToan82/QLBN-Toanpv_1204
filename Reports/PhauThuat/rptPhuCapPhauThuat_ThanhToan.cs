...
namespace NamDinh_QLBN.Reports.PhauThuat
{
    ...
    public partial class rptPhuCapPhauThuat_ThanhToan : DataDynamics.ActiveReports.ActiveReport3
    {
        ...
        public rptPhuCapPhauThuat_ThanhToan(object ThangBaoCao)
        {
            //
        ...
        private void rptPhuCapPhauThuat_ThanhToan_DataInitialize(object sender, EventArgs e)
        {
            ...
            _ds.SQL = String.Format("SET dateformat dmy SELECT DMPHAUTHUAT.LOAIPHAUTHUAT,DMPHAUTHUAT.KYTHUATCAO,B.VITRI,DMBACSY.MABS,DMBACSY.MAKHOA,DMKHOAPHONG.Tentat as TenKhoa, Upper(DMBACSY.TENBS) AS TENBS FROM"
                ...
                + "  WHERE a.ThoiGianBD >= '01/05/2022 00:00:01' and DateDiff(mm,CHITIET.thoigianthanhtoan,'{0:dd/MM/yyyy}')=0 and DMPHAUTHUAT.LoaiPhauThuat in (11,21,3,4) ORDER BY DMKHOAPHONG.TENKHOA, DMBACSY.MaBS", _ThangBC);
            this.DataSource = _ds;

...
namespace NamDinh_QLBN.Reports.PhauThuat
{
    ...
    /// </summary>
    public partial class rptPhuCapPhauThuat : DataDynamics.ActiveReports.ActiveReport3
    {
        private object _ThangBC;
        public rptPhuCapPhauThuat(object ThangBaoCao)
        {
            //
        ...
        private void rptPhuCapPhauThuat_DataInitialize(object sender, EventArgs e)
        {
            ...
            _ds.SQL = String.Format("SELECT DMPHAUTHUAT.LOAIPHAUTHUAT,DMPHAUTHUAT.KYTHUATCAO,B.VITRI,DMBACSY.MABS,DMBACSY.MAKHOA,DMKHOAPHONG.Tentat as TenKhoa, Upper(DMBACSY.TENBS) AS TENBS FROM"
                ...
                + "  WHERE DATEDIFF(MM,A.THOIGIANBD,'{0:MM/dd/yyyy}') = 0 and DMPHAUTHUAT.LoaiPhauThuat in (11,21,3,4) ORDER BY DMKHOAPHONG.TENKHOA, DMBACSY.MaBS", _ThangBC);
            this.DataSource = _ds;

...
namespace NamDinh_QLBN.Reports.PhauThuat
{
    ...
    /// </summary>
    public partial class rptPhuCapThuThuat_PM_ThanhToan : DataDynamics.ActiveReports.ActiveReport3
    {
        private object _ThangBC;
        public rptPhuCapThuThuat_PM_ThanhToan(object ThangBaoCao)
        {
            //
            ...
            lblThangBC.Text = String.Format("THÁNG  THANH TOÁN {0:MM} NĂM {0:yyyy}", ThangBaoCao);
        }
        private void rptPhuCapPhauThuat_ReportStart(object sender, EventArgs e)
        {
        ...
        private void rptPhuCapPhauThuat_DataInitialize(object sender, EventArgs e)
        {
            DataDynamics.ActiveReports.DataSources.SqlDBDataSource _ds = new DataDynamics.ActiveReports.DataSources.SqlDBDataSource();
            _ds.ConnectionString = GlobalModuls.Global.glbConnectionString;
            _ds.SQL = String.Format("set dateformat dmy SELECT DMPHAUTHUAT.LOAIPHAUTHUAT,DMPHAUTHUAT.KYTHUATCAO,B.VITRI,DMBACSY.MABS,DMBACSY.MAKHOA,DMKHOAPHONG.Tentat as TenKhoa, Upper(DMBACSY.TENBS) AS TENBS FROM"
                ...
                + "  WHERE a.ThoiGianBD >= '01/05/2022 00:00:01' and DateDiff(mm,CHITIET.thoigianthanhtoan,'{0:dd/MM/yyyy}')=0 and DMPHAUTHUAT.LoaiPhauThuat in (5,51,52,53) ORDER BY DMKHOAPHONG.TENKHOA, DMBACSY.MaBS", _ThangBC);
            this.DataSource = _ds;
        ...
        private void rptPhuCapPhauThuat_FetchData(object sender, FetchEventArgs eArgs)
        {
            if (eArgs.EOF)
            {
            }

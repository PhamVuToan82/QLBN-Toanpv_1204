...
namespace NamDinh_QLBN.Reports.PhauThuat
{
    ...
    /// </summary>
    public partial class rptCaThuThuat_byKhoa : DataDynamics.ActiveReports.ActiveReport3
    {
        private DateTime _tungay, _denngay;
        public string _makhoa, _Tenkhoa;
        public rptCaThuThuat_byKhoa(DateTime tungay, DateTime denngay, string Makhoa, string Tenkhoa)
        {
            //
        ...
        private void rptCaPhauThuat_DataInitialize(object sender, EventArgs e)
        {
            ...
            _ds.SQL = String.Format("SELECT a.SoBLVP,a.MaVaoVien,a.SoPhieuCD,a.LoaiDichVu,a.MaPT,Hoten,ThoiGianBD,TenTat as tentat1,ChanDoan_TruocPT,PhuongPhapPT_Text,Left(LoaiPhauThuat,1) As LoaiPT,b.SoHSBA,"
                ...
                + " WHERE DATEDIFF(dd,ThoiGianBD,'{0:MM/dd/yyyy}') <= 0 and DATEDIFF(dd,ThoiGianBD,'{1:MM/dd/yyyy}') >= 0 and d.makhoa = '{2}' and f.LoaiPhauThuat in (5,51,52,53) ORDER BY Left(LoaiPhauThuat,1), ThoiGianBD ", _tungay, _denngay, _makhoa);
            this.DataSource = _ds;

...
namespace NamDinh_QLBN.Reports.PhauThuat
{
    ...
    /// </summary>
    public partial class rptCaPhauThuat_ThanhToan : DataDynamics.ActiveReports.ActiveReport3
    {
        private object _ThangBC;
        public rptCaPhauThuat_ThanhToan(object ThangBC)
        {
            //
            ...
            InitializeComponent();
            _ThangBC = ThangBC;
            lblThang.Text = String.Format("Tháng thanh toán {0:MM} năm {0:yyyy}", ThangBC);
        }
        ...
        private void rptCaPhauThuat_ThanhToan_DataInitialize(object sender, EventArgs e)
        {
            DataDynamics.ActiveReports.DataSources.SqlDBDataSource _ds = new DataDynamics.ActiveReports.DataSources.SqlDBDataSource();
            _ds.ConnectionString = GlobalModuls.Global.glbConnectionString;
            _ds.SQL = String.Format("set dateformat dmy SELECT a.SoBLVP,a.MaVaoVien,a.SoPhieuCD,a.LoaiDichVu,a.MaPT,Hoten,ThoiGianBD,TenTat as tentat1,ChanDoan_SauPT as ChanDoan_TruocPT,PhuongPhapPT_Text,Left(LoaiPhauThuat,1) As LoaiPT,b.SoHSBA,"
                ...
                + " WHERE a.ThoiGianBD >= '01/05/2022 00:00:01' and DateDiff(mm,b.thoigianthanhtoan,'{0:dd/MM/yyyy}')=0 and f.LoaiPhauThuat in (11,21,3,4) ORDER BY Left(LoaiPhauThuat,1) , ThoiGianBD ", _ThangBC);
            this.DataSource = _ds;
        ...
        private void rptCaPhauThuat_ThanhToan_FetchData(object sender, FetchEventArgs eArgs)
        {
            int SN = 0;
            if (eArgs.EOF)
            {

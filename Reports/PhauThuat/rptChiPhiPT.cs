...
namespace NamDinh_QLBN.Reports.PhauThuat
{
    ...
    /// </summary>
    public partial class rptChiPhiPT : DataDynamics.ActiveReports.ActiveReport3
    {

        public rptChiPhiPT(string MaVaoVien,string HoTen,string Tuoi,string DoiTuong,string NgayVaoVien,string NgayPT,string ChanDoan,string ChiDinh,string BsGayMe,string DieuDuong)
        {
            //

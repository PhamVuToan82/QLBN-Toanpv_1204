...
namespace NamDinh_QLBN.Reports
{
    ...
    /// </summary>
    public partial class repPhieuMuonVai_2 : DataDynamics.ActiveReports.ActiveReport3
    {
        private String _MaKhamBenh;
        private int STT = 0;
        int page = 0;
        public repPhieuMuonVai_2(String MaKhamBenh)
        {
            //
        ...
        private void groupHeader2_BeforePrint(object sender, EventArgs e)
        {
            ...
            label24.Text = "Nam định: " + String.Format("Ngày {0:dd} tháng {0:MM} năm {0:yyyy}", NgayMuon);
        }
    }
}

...
namespace NamDinh_QLBN.Reports
{
    ...
    /// </summary>
    public partial class repHoiChan : DataDynamics.ActiveReports.ActiveReport3
    {
        private String _MaVaoVien = "";
        String _Loai = "";
        public repHoiChan(String MaVaoVien,String Loai)
        {
            //
        ...
        private void repHoiChan_DataInitialize(object sender, EventArgs e)
        {
            ...
            _ds.SQL = String.Format("select HoTen,Year(getdate()) - NamSinh as tuoi,case when GioiTinh = 0 then N'Giới tính: Nữ' else N'Giới tính: Nam' end as GT,DieutriTNgay,DieuTriDNgay,"
                ...
                + " inner join dmkhoaphong on dmkhoaphong.makhoa = v.makhoa where Loai={1}", _MaVaoVien,_Loai);
            this.DataSource = _ds;
        }
    }
}

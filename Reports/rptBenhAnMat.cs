...
{
    /// <summary>
    /// Summary description for rptBenhAnMat.
    /// </summary>    
    public partial class rptBenhAnMat : DataDynamics.ActiveReports.ActiveReport3
    {
        private string MaBenhNhan = "";
        private string LanVaoVien = "0";
        public rptBenhAnMat(string _MaBenhNhan, string _LanVaoVien, string TenKhoa)
        {
            //

...
namespace NamDinh_QLBN.Reports
{
    ...
    /// </summary>    
    public partial class rptBenhAnNgoai : DataDynamics.ActiveReports.ActiveReport3
    {
        private string MaBenhNhan = "";
        private string LanVaoVien = "0";
        public rptBenhAnNgoai(string _MaBenhNhan,string _LanVaoVien,string TenKhoa)
        {
            //
        ...
        private void rptBenhAnNgoai_ReportStart(object sender, EventArgs e)
        {
            ...
            SQLCmd.CommandText = string.Format("SELECT BENHNHAN.HoTen," + GlobalModuls.Global.NgayLV.Year + "-NamSinh As Tuoi,GioiTinh,MaDanToc,DMDANTOC.TenDT,TenDonVi,DonVi_ChiTiet, "
                                ...
                                + " BacSyKham,NgayKham ,TrieuChung_VV,MaNoiCapBHYT,MaDTBHYT"
            ...
            while (dr.Read())
            {
                ...
                {
                    label46.Text = "23. KKB, Cấp cứu: " + dr["TrieuChung_VV"].ToString();
                }
                lblQuanHam.Text = "6. Quân hàm: " + dr["TenQH"];
                lblDonVi.Text = dr["DonVi_ChiTiet"].ToString() + " - " + dr["TenDonVi"].ToString();
                lblDiaChi.Text = dr["NoiO"].ToString() + " - " + dr["TenTinh"];
                ...
                lblLienHe.Text =  dr["LienHe"].ToString();

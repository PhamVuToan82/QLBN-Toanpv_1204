...
namespace NamDinh_QLBN.Reports
{
    ...
    /// </summary>
    public partial class Subrpt_BenhAn_BA_RHM : DataDynamics.ActiveReports.ActiveReport3
    {
        string _MaVaoVien;
        int _LoaiBenhAn;
        public Subrpt_BenhAn_BA_RHM(string MaVaoVien, int LoaiBenhAn)
        {
            //
        ...
        private void groupHeader1_Format(object sender, EventArgs e)
        {
            ...
            //{
            //    Subrpt_BenhAn_BA_RHM_CoQuan_NoiNgoai rtpcoquan = new Subrpt_BenhAn_BA_RHM_CoQuan_NoiNgoai(_MaVaoVien);

...
namespace NamDinh_QLBN.Reports
{
    ...
    /// Summary description for rptChiPhiPT
    /// </summary>
    public partial class rptBA_RHM : DataDynamics.ActiveReports.ActiveReport3
    {
        string _MaVaoVien, _TenKhoa, _NgayChuyen, _NgayDT,_Hsba,_LuuTru;
        int _LoaiBenhAn;
        public rptBA_RHM(string MaVaoVien, string TenKhoa, string NgayChuyen, string NgayDT, string hsba, string Luutru, int LoaiBenhAn)
        {
            //
        ...
        {
            Subrpt_BenhAn_BA_RHM rtpBenhAn = new Subrpt_BenhAn_BA_RHM(_MaVaoVien,_LoaiBenhAn);

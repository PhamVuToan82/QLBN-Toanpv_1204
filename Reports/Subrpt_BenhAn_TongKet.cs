...
namespace NamDinh_QLBN.Reports
{
    ...
    /// </summary>
    public partial class Subrpt_BenhAn_TongKet : DataDynamics.ActiveReports.ActiveReport3
    {
        string _MaVaoVien;
        public Subrpt_BenhAn_TongKet(string MaVaoVien)
        {
            //
        ...
        {
            if ((Fields["TongKet_PhuongPhapDieuTri"].Value.ToString()) == "Điều trị triệt để")
            {
                textBox1.Text = "X";
            }
            else textBox1.Text = "";
            if ((Fields["TongKet_PhuongPhapDieuTri"].Value.ToString()) == "Điều trị triệu chứng")
            {
                textBox2.Text = "X";
            }
            else textBox2.Text = "";

            if ((Fields["TongKet_PhuongPhapDieuTri_DapUng"].Value.ToString()) == "Không đáp ứng")
            {
                textBox9.Text = "X";
            }
            else textBox9.Text = "";
            if ((Fields["TongKet_PhuongPhapDieuTri_DapUng"].Value.ToString()) == "Bán phần")
            {
                textBox10.Text = "X";
            }
            else textBox10.Text = "";
            if ((Fields["TongKet_PhuongPhapDieuTri_DapUng"].Value.ToString()) == "Hoàn toàn")
            {
                textBox12.Text = "X";
            }
            else textBox12.Text = "";

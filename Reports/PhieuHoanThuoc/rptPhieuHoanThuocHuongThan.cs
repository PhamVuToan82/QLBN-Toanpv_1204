...
namespace NamDinh_QLBN.Reports.PhieuHoanThuoc
{
    ...
    /// </summary>
    public partial class rptPhieuHoanThuocHuongThan : DataDynamics.ActiveReports.ActiveReport3
    {
        private int STT = 0;
        private int page = 0;
        ...
        public string So;
        public rptPhieuHoanThuocHuongThan(string Khoa, String Ngay,string SoLuuTru)
        {
            //
        ...
        private void detail_Format(object sender, EventArgs e)
        {
            ...
            txtCongKhoan.Text = STT.ToString() + " khoản";
        }

        private void detail_BeforePrint(object sender, EventArgs e)
        {
            label2.Height = textBox2.Height = textBox3.Height = textBox4.Height = textBox5.Height = textBox9.Height = textBox8.Height = detail.Height;
        }

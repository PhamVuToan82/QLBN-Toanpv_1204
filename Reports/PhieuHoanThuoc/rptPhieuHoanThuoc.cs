...
namespace NamDinh_QLBN.Reports.PhieuHoanThuoc
{
    ...
    /// </summary>
    public partial class rptPhieuHoanThuoc : DataDynamics.ActiveReports.ActiveReport3
    {
        int page = 0;
        public rptPhieuHoanThuoc(string TenKhoa, string Ngay,string SoLuuTru)
        {
            //

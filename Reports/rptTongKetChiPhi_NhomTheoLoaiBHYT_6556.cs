...
namespace NamDinh_QLBN.Reports
{
    ...
    /// </summary>
    public partial class rptTongKetChiPhi_NhomTheoLoaiBHYT_6556 : DataDynamics.ActiveReports.ActiveReport3
    {
        ...
        public rptTongKetChiPhi_NhomTheoLoaiBHYT_6556(string MaBenhNhan, string TenBN, string Tuoi, string GioiTinh, string DoiTuong, object NgayVaoVien, string DiaChi, string HanTheTu, string HanTheDen, string SoThe, string NoiCap, string Buong, string Giuong, DateTime NgayRaVien, string ChanDoan, string NoiGioiThieu, String SoHSBA,string MaKhoa,string LoaiBenhAn,string CapCuu, DateTime NGAYKHAM)
        {
            //

...
namespace NamDinh_QLBN.Reports
{
    ...
    /// </summary>
    public partial class rptPhieuTraVai : DataDynamics.ActiveReports.ActiveReport3
    {
        private int STT = 1;
        int page = 0;
        ...
        public rptPhieuTraVai(DateTime Ngay,DateTime NgayHT, string Khoa)
        {
            //
            ...
            String.Format("In ngày {0:dd} tháng {0:MM} năm {0:yyyy}", Global.NgayLV);
            _TenKhoa = Khoa;
            _TuNgay = Ngay;
            _DenNgay = NgayHT;
        ...
        private void detail_Format(object sender, EventArgs e)
        {
            ...
            //TongSo = TongSo + int.Parse(textBox7.Text);
        }
        ...
        private void rptPhieuTraVai_PageStart(object sender, EventArgs e)
        {
            page += 1;
        ...
        private void rptPhieuTraVai_DataInitialize(object sender, EventArgs e)
        {
            ...
            _ds.SQL = _ds.SQL + "and b.HoanTien_M = 1 group by b.tendovai, c.Dvt, a.TenKhoa  order by a.TenKhoa";
            this.DataSource = _ds;
        }
    }
}

...
namespace NamDinh_QLBN.Reports
{
    ...
    /// </summary>
    public partial class repGiayXinMau : DataDynamics.ActiveReports.ActiveReport3
    {
        private string _MaVaoVien, _SoPhieu, _khoa;
        private object _NgayTH;
        public repGiayXinMau(String MaVaoVien,String SoPhieu,object NgayTH, string khoa)
        {
            //
            ...
            {
                label15.Text = "GIÁM ĐỐC TRUNG TÂM";
            }
        }
        ...
        private void repGiayXinMau_ReportStart(object sender, EventArgs e)
        {
            ...
            lblNgayThang.Text = String.Format("{0:HH} giờ {0:mm} - Ngày {0:dd} tháng {0:MM} năm {0:yyyy}", _NgayTH);
        }

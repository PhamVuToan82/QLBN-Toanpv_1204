...
namespace NamDinh_QLBN.Reports
{
    ...
    /// Summary description for rptChiPhiPT
    /// </summary>
    public partial class rptBA_TaiMuiHong : DataDynamics.ActiveReports.ActiveReport3
    {
        string _MaVaoVien, _TenKhoa, _NgayChuyen, _NgayDT,_Hsba,_LuuTru;
        int _LoaiBenhAn;
        public rptBA_TaiMuiHong(string MaVaoVien, string TenKhoa, string NgayChuyen, string NgayDT, string hsba, string Luutru, int LoaiBenhAn)
        {
            //
        ...
        {
            Subrpt_BenhAn_TongKet_NgoaiKhoa rpttongket = new Subrpt_BenhAn_TongKet_NgoaiKhoa(_MaVaoVien);
            subReport5.Report = rpttongket;
        }

        private void groupFooter2_Format(object sender, EventArgs e)
        {
            Subrpt_BenhAn_BA_TaiMuiHong rtpBenhAn = new Subrpt_BenhAn_BA_TaiMuiHong(_MaVaoVien,_LoaiBenhAn);

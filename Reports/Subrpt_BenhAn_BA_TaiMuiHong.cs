...
namespace NamDinh_QLBN.Reports
{
    ...
    /// </summary>
    public partial class Subrpt_BenhAn_BA_TaiMuiHong : DataDynamics.ActiveReports.ActiveReport3
    {
        string _MaVaoVien;
        int _LoaiBenhAn;
        public Subrpt_BenhAn_BA_TaiMuiHong(string MaVaoVien, int LoaiBenhAn)
        {
            //
        ...
        private void groupHeader1_Format(object sender, EventArgs e)
        {
            ...
            //{
            //    Subrpt_BenhAn_BA_TaiMuiHong_CoQuan_NoiNgoai rtpcoquan = new Subrpt_BenhAn_BA_TaiMuiHong_CoQuan_NoiNgoai(_MaVaoVien);
            //    subReport2.Report = rtpcoquan;
            //}
            //else
            //{
            Subrpt_BenhAn_BA_CoQuan_TaiMuiHong rtpcoquan = new Subrpt_BenhAn_BA_CoQuan_TaiMuiHong(_MaVaoVien);
            subReport2.Report = rtpcoquan;
            //}
        }
    }

...
namespace NamDinh_QLBN.Reports.BaoCaoVeThuoc
{
    ...
    /// </summary>
    public partial class rptPhieuLinhThuocGayNghien : DataDynamics.ActiveReports.ActiveReport3
    {
        private int STT = 0;
        private int page = 0;
        ...
        public rptPhieuLinhThuocGayNghien(string Khoa,String Ngay)
        {
            //
        ...
        {
            label9.Height =textBox6.Height = textBox7.Height = textBox8.Height = textBox10.Height = detail.Height;
        }        

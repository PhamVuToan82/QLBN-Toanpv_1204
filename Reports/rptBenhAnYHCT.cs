...
namespace NamDinh_QLBN.Reports
{
    ...
    /// </summary>
    public partial class rptBenhAnYHCT : DataDynamics.ActiveReports.ActiveReport3
    {
        private string MaBenhNhan = "";
        private string LanVaoVien = "0";

        public rptBenhAnYHCT(string _MaBenhNhan, string _LanVaoVien, string TenKhoa)
        {
            //
        ...
        {
            this.Document.Name = "Bệnh án Y học cổ truyền";

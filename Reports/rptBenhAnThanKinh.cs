...
namespace NamDinh_QLBN.Reports
{
    ...
    /// </summary>    
    public partial class rptBenhAnThanKinh : DataDynamics.ActiveReports.ActiveReport3
    {
        private string MaBenhNhan = "";
        private string LanVaoVien = "0";
        public rptBenhAnThanKinh(string _MaBenhNhan, string _LanVaoVien, string TenKhoa)
        {
            //

...
namespace NamDinh_QLBN.Reports
{
    ...
    /// </summary>
    public partial class Subrpt_BenhAn_TongKet_NgoaiKhoa : DataDynamics.ActiveReports.ActiveReport3
    {
        string _MaVaoVien;
        public Subrpt_BenhAn_TongKet_NgoaiKhoa(string MaVaoVien)
        {
            //
